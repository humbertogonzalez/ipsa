...
<?php
    ...
    $cuentas_pagar = "SELECT proveedor,nombre, fecha_pago,SUM(monto_pago) AS total, SUM(abono) AS abono, (SUM(monto_pago) - SUM(abono)) as saldo_restante, peridiocidad FROM tesoreria WHERE tipo_cuenta=1 GROUP BY proveedor ASC;";
        ...
        <div class="panel panel-default">
            <div class="panel-heading clearfix">
                <strong>
                    ...
                    <span>Cuentas por Pagar Externas</span>
                </strong>
                <a href="add_cuenta_externa.php" class="btn btn-info pull-right tablesorter">Alta de cuenta por pagar</a>
            </div>
                    ...
                    <tbody>
                        <?php while($row = $rs_result->fetch_assoc()) { ?>
                            <tr>
                                ...
                                <td class="text-center"><?php echo $row["peridiocidad"]?></td>
